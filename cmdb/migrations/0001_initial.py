    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', models.ManyToManyField(blank=True, to='rbac.Role', verbose_name='管理角色')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_unit', models.ManyToManyField(blank=True, null=True, to='cmdb.BusinessUnit')),
                ('idc', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmdb.IDC')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('creator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='rbac.UserProfile')),
                ('server_obj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ar', to='cmdb.Server')),
            ],
            options={
