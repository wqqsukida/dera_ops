...
class Runner(object):
    def __init__(self,sources,*args,**kwargs):
        ...
        self.sources = sources # sources=['/etc/ansible/hosts'] or '172.17.0.2,172.17.0.3'
        self.inventory = InventoryManager(loader=self.loader,sources=self.sources)

        self.variable_manager = VariableManager(loader=self.loader, inventory=self.inventory)
        # 扩展加入变量用户名,密码
        self.variable_manager.extra_vars = {"ansible_user": "root", "ansible_ssh_pass": "test"}
        self.passwords = None
        self.results_raw = {}
    ...
    def run_playbook(self,extra_vars=None):
        ...
        playbook = PlaybookExecutor(playbooks=['/home/wuyifei/pro06/dera_ops/utils/playbooks/client_update.yml'],
                                    inventory=self.inventory,
                                    variable_manager=self.variable_manager,
                                    loader=self.loader,
                                    options=self.options,
...
if __name__ == "__main__":
    c = Runner('172.17.0.16,172.17.0.19,')   # ['/etc/ansible/hosts'] or '172.17.0.2,172.17.0.3'
    # c.run_ad_hoc()
    c.run_playbook()
    # print (c.get_adhoc_result())
    ...
    '''
    {
        "success": {
            "172.17.0.2": {
                "stderr": "",
                "stderr_lines": [],
                "start": "2018-10-11 06:25:25.227928",
                "cmd": "hostname",
                "end": "2018-10-11 06:25:25.248382",
                "_ansible_parsed": true,
                "stdout": "docker_server30",
                "delta": "0:00:00.020454",
                "changed": true,
                "_ansible_no_log": false,
                "rc": 0,
                "stdout_lines": [
            ...
            "172.17.0.3": {
                "stderr": "",
                "stderr_lines": [],
                "start": "2018-10-11 06:25:25.232889",
                "cmd": "hostname",
                "end": "2018-10-11 06:25:25.252864",
                "_ansible_parsed": true,
                "stdout": "docker_server29",
                "delta": "0:00:00.019975",
                "changed": true,
                "_ansible_no_log": false,
                "rc": 0,
                "stdout_lines": [
